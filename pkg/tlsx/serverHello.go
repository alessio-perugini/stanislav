...
//TODO finire la versione
func (ch *ServerHelloBasic) Security() (cipher, version uint8) {
	switch ch.CipherSuite {
	case 49169:
		fallthrough /* TLS_ECDHE_RSA_WITH_RC4_128_SHA */
	case 5:
		fallthrough /* TLS_RSA_WITH_RC4_128_SHA */
	case 4:
		cipher = 2 /* TLS_RSA_WITH_RC4_128_MD5 */
		/* WEAK */
	case 157:
	...
	case 7:
		cipher = 1 /* TLS_RSA_WITH_IDEA_CBC_SHA */
	default:
		cipher = 0
	}
